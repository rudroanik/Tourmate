...
public class AdapterViewEvent extends RecyclerView.Adapter<AdapterViewEvent.MyViewHolder> {
    private ArrayList<TravelEvent> eventList = new ArrayList<>();
    Context ctx;

    public AdapterViewEvent(ArrayList<TravelEvent> eventList, Context ctx) {
